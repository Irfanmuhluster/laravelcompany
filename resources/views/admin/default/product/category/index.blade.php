...
<div class="card">
    <div class="card-body">
        ...
        <form id="search" action="{{ route('admin.produkcategory.index') }}" method="GET">
        ...
        <table class="table shadow thspan-6" id="tableList">
            <thead class="thead-light">
                <tr>
                    ...
                    <th scope="col"><span class="d-none d-md-block">Nama Kategori</span></th>
                    <th scope="col">Aksi</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($datacategory as $index => $category)
                <tr>
                    <td scope="row">
                        {{ $rank++ }}
                    </td>
                    ...
                    <td>
                        <a title="Ubah" class="btn btn-sm btn-primary pull-right category-menu-edit-btn"  data-route-edit="{{ route('admin.produkcategory.update', $category->id) }}" data-category-name="{{ $category->category_name }}" id="category-menu-edit-btn" data-toggle="modal" data-target="#editCategory">
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="modal-body">    
                                        <form id="role-menu-form-delete" action="{{ route('admin.produkcategory.delete', ['category' => $category->id]) }}" spellcheck="false"  method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <div class="mb-4 pb-2">Apa Anda yakin ingin menghapus Kategori ini ?</div>
...
<div class="modal fade scale"  id="editCategory" tabindex="-1" role="dialog" aria-labelledby="editCategoryTitle" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form id="category-form-edit" action="" spellcheck="false" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="modal-body"> 
                        <div class="form-group">
                            <label for="menuLabelId"><strong>Nama Category<span class="text-danger">*</span></strong></label>
                            <input type="text" name="edit_category_name" class="form-control @error('edit_category_name') is-invalid @enderror" value="{{ old('edit_category_name') }}">
...
<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form spellcheck="false" action="{{ route('admin.produkcategory.store') }}" id="role-form"  method="POST">
            <div class="modal-body">
                <div class="modal-body">
                    
                        @csrf
                        <div class="form-group">
                            <label for="accessTitle"><strong>Nama Kategori <span class="text-danger">*</span></strong></label>
                            <div class="form-group">
